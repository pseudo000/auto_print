...
class SpreadsheetGUI(QWidget):
    ...
    def submit_value(self):
        ...
        if is_value_exists:
            ...
            last_scanned_item.setSelected(True)
            
            # Deselect previous item and select last scanned item
            previous_item = self.tree.currentItem()
            if previous_item:
                previous_item.setSelected(False)
            self.tree.setCurrentItem(last_scanned_item)
            
            # Scroll to last scanned item
...
##################################################
    ...
    def print_pages_with_number(self, formatted_number):
        ...
        self.inspection_tree.setCurrentItem(row)
...
# nuitka 12_addsearch.py --output-dir=C:\Users\swwoo\Desktop\AUTO_PRINT\compiled --recurse-to=ALL
# nuitka --output-dir=C:\Users\swwoo\Desktop\AUTO_PRINT\compiled 12_addsearch.py
